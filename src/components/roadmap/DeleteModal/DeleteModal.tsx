  ...
  return (
    <>
      {deleteCandidate && (
        ...
        >
          <div
            className="animate-in zoom-in-95 w-full max-w-[300px] overflow-hidden rounded-[24px] bg-white/95 shadow-2xl ring-1 ring-black/5 backdrop-blur-xl dark:bg-[#2C2C2E]/95 dark:ring-white/10"
